...
import 'package:reterewe/models/shop_category.dart';
...
class Dummy {
  ...
  static const List<String> shop_category_title = [
    "Pesan", "Fashion", "Beauty and Health", "Babies and Kids",
  ];
  ...
  "image_4.jpg", "image_19.jpg", "image_20.jpg", "image_21.jpg"
  ];
  ...
  static const List<String>  shop_product_price = [
    "\Rp 25.000", "\Rp 19.000", "\Rp 16.000", "\Rp 14.500", "\Rp 10.000",
    "\Rp 10.000", "\Rp 18.000", "\Rp 19.000",
  ];
  ...
  static List<String> getNatureImages([int count = 14]) {
    ...
    for(String s in images){
      natureImages.add('assest/images/${s}');
    }
